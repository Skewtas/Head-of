-- Stodona Standard v8 — tvåspråkig SV/EN, med anställningsnummer + bankkonto + Extra intjäning
UPDATE "contract_templates"
SET "content" = $V8$<div style="font-family:Inter,'Helvetica Neue',Arial,sans-serif;color:#1a1a2e;line-height:1.55;max-width:720px;margin:0 auto;padding:0 8px;font-size:14px;">
...
<div style="padding:22px 0 8px;border-top:1px solid #eae4d9;margin-top:8px;">
  ...
  <div style="padding:20px 24px;background:#faf7ee;border-left:3px solid #c9a96e;">
    <div style="display:grid;grid-template-columns:210px 1fr;column-gap:24px;padding:10px 0;">
      ...
      <div style="font-size:14px;color:#1a1a2e;font-weight:500;">Sysselsättningsgrad i genomsnitt över perioden — kan variera vecka till vecka<span style="display:block;font-size:12.5px;color:#8b8578;margin-top:3px;font-style:italic;font-weight:400;">Percentage averaged across the period — may vary week to week</span></div>
    </div>
    <div style="display:grid;grid-template-columns:210px 1fr;column-gap:24px;padding:10px 0;border-top:1px solid #d8cfbc;">
...
<div style="padding:18px 0;background:#1a1a2e;color:#cec7b8;font-size:10.5px;letter-spacing:0.08em;text-align:center;">
  <strong style="color:#f5f3ef;">{{company.name}}</strong> · {{company.address}} · Stodona Standard v8 · SV / EN · {{today}}
</div>
